...
<div class="container">
        <h6>修改用户信息</h6>
        <hr/>
    <form method="post" action="${app}/user/updatecus">
        <div class="form-group">
            <label for="cname">cname:</label>
            <input type="hidden" name="cid" value="${customer.cid}" />
            <input type="text" readonly="readonly" name="cname" value="${customer.cname}" class="form-control" id="cname">
        </div>
        <div class="form-group">
            <label for="cphone">cphone:</label>
<%--            <input type="hidden" name="cphone" value="${customer.cphone}" />--%>
