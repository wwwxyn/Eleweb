    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="post" action="${app}/ordersrest/opt" enctype="multipart/form-data" class="form-horizontal" role="form">
...
<script>
    ...
    function updateForm(ele) {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $('#updateModal [data-my="fcid"]').attr('src',result.dataZone.obj.fcid);
    ...
    function gotoPage(pageNum, pageSize) {
        ...
        $.ajax({
            type: "GET",
            url: "${app}/ordersrest/list?pageNum=" + pageNum + "&pageSize=" + pageSize,
            dataType: "json",
            data: $("#searchForm").serialize(),
            success: function (result) {
    ...
    function parseDataAndShow(result) {
        ...
        $.each(lists, function (index, item) {
            ...
            var td4 = $('<td></td>').text(item.fgid.toFixed(2));
            var td5 = $('<td></td>').text(item.fcid);
            var td6 = $('<td></td>').text(item.fbid);
